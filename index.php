    ...
    <main>
                        ...
                        <?php
                            ...
                            if ($the_query->have_posts()) :
                                while ($the_query->have_posts()) :
                                    ...
                                    echo '<div class="row">';
                                    echo '<dt>'.$cat_name.'</dt>';
                                    echo '<dd><a href="'.$link.'">'.$title.'</a></dd>';
                                    echo '</div>';
                                endwhile;
                            else :
                                echo '<div class="row">';
                                echo '<dd><a href="/" style="pointer-events: none;">申し訳ありません、ただいま記事を準備中です。</a></dd>';
                                echo '</div>';
                            endif;
                            wp_reset_query();
                        ?>
                    </dl>
                    <div class="blog-ling cmn-link"><a href="#">もっと見る</a></div>
                </div>
            </div>
        </section>
        <section class="faq cmn-section -black">
            ...
            <div class="faq-cont">
                <ul class="faq-list">
                    <li class="faq-item">
                        <a href="javascript:void(0)" class="title js-accodion"><p>Q. チェックイン、チェクアウトの時間は何時ですか？</p></a>
                        <div class="detail"><p>A. チェックインの時間は15:00～17:00です。もし17:00を過ぎるようでしたら、ご一報を入れていただくよう お願いしております。チェックアウトの時間は翌朝10:00でございます。</p></div>

                    </li>
                    <li class="faq-item">
                        <a href="javascript:void(0)" class="title js-accodion"><p>Q. 露天風呂がついたお部屋はありますか？</p></a>
                        <div class="detail"><p>A. 露天風呂付のお部屋は全部で24室ございます。</p></div>

                    </li>
                    <li class="faq-item">
                        <a href="javascript:void(0)" class="title js-accodion"><p>Q. ペットを連れて行きたいのですが可能ですか？</p></a>
                        <div class="detail"><p>A. ペット同伴のご宿泊はお断りさせて頂いております。お車で5分ほどの場所に、一時預かりを行っているペット ハウスがございますのでそちらのご利用をお願い致します。</p></div>

                    </li>
                    <li class="faq-item">
                        <a href="javascript:void(0)" class="title js-accodion"><p>Q. キャスター付きのバッグで行っても大丈夫ですか？</p></a>
